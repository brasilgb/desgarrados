    ...
    <div className="w-full py-8 bg-[#F3F4F6]">
      <div className="container mx-auto">
        <div className="flex flex-col items-center justify-start">
          <h1 className="text-2xl font-bold text-secundary-dark flex-none mr-2">Ouça as playlists recentes</h1>
          <h1 className="text-base uppercase font-bold text-secundary-dark flex-none mr-2">Clique no play e curta a música</h1>
          {/* <div className="h-2 w-full border-y border-t-primary-green border-b-primary-yellow" /> */}
        </div>
        <div className="container mx-auto md:grid md:grid-cols-4 gap-8 mt-4">

          <div className="h-[360px]">
            <div className="relative flex flex-col group rounded-2xl overflow-hidden z-0  h-full">
              ...
              <div className="absolute w-full h-full flex flex-col items-center justify-center">
                <div className="w-full flex flex-grow items-center justify-center">
                  <IconContext.Provider value={{ className: "text-secundary-light text-2xl" }} >
